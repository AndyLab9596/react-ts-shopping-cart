...
const CartItem: React.FC<CartType> = ({ id, img, title, price, amount }) => {
    const { toggleAmount, removeItem } = useShopContext();
    ...
    return (
        <article className='cart__item'>
            ...
            <div>
                ...
                {/* remove button */}
                <button className='cart__item__remove' onClick={() => removeItem(id)} >
                    remove
                </button>
            </div>
            <div>
                {/* increase amount */}
                <button className='cart__item-adjust' onClick={() => toggleAmount(id, 'inc')} >
                ...
                {/* decrease amount */}
                <button className='cart__item-adjust' onClick={() => toggleAmount(id, 'dec')} >
                    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20'>
